...
class Produit(db.Model):
    ...
    prix_gros=db.Column(db.DECIMAL(precision=10, scale=2, asdecimal=False))
    emballage=db.Column(db.String(200))
    nombre_contenu = db.Column(db.Integer)
    mesure=db.Column(db.String(200))
    emballage_contenu=db.Column(db.String(200))
    nombre_contenu_emballage = db.Column(db.Integer)
    mesure_em=db.Column(db.String(200))
    perissable=db.Column(db.Boolean, default=False)
    avatar=db.Column(db.String(200), default='pro.jpg')
...
class Categorie(db.Model):
    ...
    statut=db.Column(db.Boolean, default=True)
    categorie_nombre = db.Column(db.Integer, default=0)
